...
To adapt the ZUQA agent to your needs, you can configure it using environment variables, or framework specific
configuration.

You can either configure the agent by setting environment variables:
[source,bash]
----
ZUQA_SERVICE_NAME=foo python manage.py runserver
----
...
To configure Django, add an `ZUQA` dictionary to your `settings.py`:
...
To configure Flask, add an `ZUQA` dictionary to your `app.config`:
...
| `ZUQA_SERVICE_NAME` | `SERVICE_NAME`    | `None`     | `my-app`
|============


The name of your service.
This is used to keep all the errors and transactions of your service together
and is the primary filter in the ZUQA user interface.
...
| `ZUQA_SERVER_URL` | `SERVER_URL`   | `'http://localhost:32140'`
|============
...
|============
| Environment             | Django/Flask   | Default 
| `ZUQA_RECORDING` | `RECORDING`    | `false`
|============

Enable or disable recording of events.
If set to false, then the Python agent does not send any events to the ZUQA server,
...
|============
| Environment                   | Django/Flask      | Default
| `ZUQA_TRANSPORT_CLASS` | `TRANSPORT_CLASS` | `zuqa.transport.http.Transport`
|============
...
|============
| Environment                     | Django/Flask         | Default    | Example
| `ZUQA_SERVICE_NODE_NAME` | `SERVICE_NODE_NAME`  | `None`     | `"redis1"`
|============
...
|============
| Environment               | Django/Flask   | Default    | Example
| `ZUQA_ENVIRONMENT` | `ENVIRONMENT`  | `None`     | `"production"`
|============
...
|============
| Environment                | Django/Flask    | Default    | Example
| `ZUQA_SECRET_TOKEN` | `SECRET_TOKEN`  | `None`     | A random string
|============
...
| `ZUQA_API_KEY` | `api_key`    | `None`   | A base64-encoded string
|============
...
|============
| Environment                    | Django/Flask        | Default    | Example
| `ZUQA_SERVICE_VERSION`  | `SERVICE_VERSION`   | `None`     | A string indicating the version of the deployed service
|============
...
|============
| Environment                  | Django/Flask     | Default
| `ZUQA_FRAMEWORK_NAME` | `FRAMEWORK_NAME` | Depending on framework
|============
...
|============
| Environment                     | Django/Flask        | Default
| `ZUQA_FRAMEWORK_VERSION` | `FRAMEWORK_VERSION` | Depending on framework
|============
...
|============
| Environment                          | Django/Flask                  | Default  | Example
| `ZUQA_FILTER_EXCEPTION_TYPES` | `FILTER_EXCEPTION_TYPES`      | `[]`     | `['OperationalError', 'mymodule.SomeoneElsesProblemError']`
...
|============
| Environment                                | Django/Flask                    | Default  | Example
| `ZUQA_TRANSACTIONS_IGNORE_PATTERNS` | `TRANSACTIONS_IGNORE_PATTERNS`  | `[]`     | `['^OPTIONS ', 'myviews.Healthcheck']`
| multiple values separated by commas, without spaces |||
|============
...
|============
| Environment                  | Django/Flask         | Default
| `ZUQA_SERVER_TIMEOUT` | `SERVER_TIMEOUT`     | `"5s"`
|============
...
|============
| Environment                | Django/Flask  | Default                | Example
| `ZUQA_HOSTNAME`     | `HOSTNAME`    | `socket.gethostname()` | `app-server01.example.com`
|============
...
|============
| Environment                   | Django/Flask      | Default
| `ZUQA_AUTO_LOG_STACKS` | `AUTO_LOG_STACKS` | `True`
| set to `"true"` / `"false"` |||
|============
...
|============
| Environment                           | Django/Flask              | Default
| `ZUQA_COLLECT_LOCAL_VARIABLES` | `COLLECT_LOCAL_VARIABLES` | `errors`
|============

Possible values: `errors`, `transactions`, `all`, `off`

The ZUQA Python agent can collect local variables for stack frames.
...
|============
| Environment                        | Django/Flask           | Default
| `ZUQA_LOCAL_VAR_MAX_LENGTH` | `LOCAL_VAR_MAX_LENGTH` | `200`
|============
...
|============
| Environment                             | Django/Flask                | Default
| `ZUQA_LOCAL_VAR_LIST_MAX_LENGTH` | `LOCAL_VAR_LIST_MAX_LENGTH` | `10`
|============
...
|============
| Environment                             | Django/Flask                | Default
| `ZUQA_LOCAL_VAR_DICT_MAX_LENGTH` | `LOCAL_VAR_DICT_MAX_LENGTH` | `10`
|============
...
|============
| Environment                                     | Django/Flask                        | Default
| `ZUQA_SOURCE_LINES_ERROR_APP_FRAMES`     | `SOURCE_LINES_ERROR_APP_FRAMES`     | `5`
| `ZUQA_SOURCE_LINES_ERROR_LIBRARY_FRAMES` | `SOURCE_LINES_ERROR_LIBRARY_FRAMES` | `5`
| `ZUQA_SOURCE_LINES_SPAN_APP_FRAMES`      | `SOURCE_LINES_SPAN_APP_FRAMES`      | `0`
| `ZUQA_SOURCE_LINES_SPAN_LIBRARY_FRAMES`  | `SOURCE_LINES_SPAN_LIBRARY_FRAMES`  | `0`
|============
...
|============
| Environment                | Django/Flask   | Default
| `ZUQA_CAPTURE_BODY` | `CAPTURE_BODY` | `off`
|============
...
|============
| Environment                   | Django/Flask      | Default
| `ZUQA_CAPTURE_HEADERS` | `CAPTURE_HEADERS` | `true`
|============
...
|============
| Environment                         | Django/Flask            | Default
| `ZUQA_TRANSACTION_MAX_SPANS` | `TRANSACTION_MAX_SPANS` | `500`
|============
...
|============
| Environment                     | Django/Flask        | Default
| `ZUQA_STACK_TRACE_LIMIT` | `STACK_TRACE_LIMIT` | `500`
|============
...
|============
| Environment                            | Django/Flask               | Default
| `ZUQA_SPAN_FRAMES_MIN_DURATION` | `SPAN_FRAMES_MIN_DURATION` | `"5ms"`
|============
...
|============
| Environment                    | Django/Flask       | Default
| `ZUQA_API_REQUEST_SIZE` | `API_REQUEST_SIZE` | `"768kb"`
|============
...
|============
| Environment                    | Django/Flask       | Default
| `ZUQA_API_REQUEST_TIME` | `API_REQUEST_TIME` | `"10s"`
|============
...
|============
| Environment              | Django/Flask | Default
| `ZUQA_PROCESSORS` | `PROCESSORS` | `['zuqa.processors.sanitize_stacktrace_locals',
...
|============
| Environment                           | Django/Flask              | Default
| `ZUQA_TRANSACTION_SAMPLE_RATE` | `TRANSACTION_SAMPLE_RATE` | `1.0`
|============
...
|============
| Environment                 | Django/Flask    | Default
| `ZUQA_INCLUDE_PATHS` | `INCLUDE_PATHS` | `[]`
| multiple values separated by commas, without spaces |||
|============
...
|============
| Environment                 | Django/Flask    | Default
| `ZUQA_EXCLUDE_PATHS` | `EXCLUDE_PATHS` | Varies on Python version and implementation
| multiple values separated by commas, without spaces |||
|============
...
|============
| Environment                 | Django/Flask   | Default
| `ZUQA_DISABLE_SEND`  | `DISABLE_SEND` | `False`
|============
...
|============
| Environment               | Django/Flask | Default
| `ZUQA_INSTRUMENT`  | `INSTRUMENT` | `True`
|============
...
|============
| Environment                       | Django/Flask         | Default
| `ZUQA_VERIFY_SERVER_CERT`  | `VERIFY_SERVER_CERT` | `True`
|============
...
|============
| Environment                | Django/Flask  | Default
| `ZUQA_SERVER_CERT`  | `SERVER_CERT` | `None`
|============
...
certificate via the `ZUQA_SERVER_CERT` configuration.
...
|============
| Environment                     | Django/Flask       | Default
| `ZUQA_METRICS_INTERVAL`  | `METRICS_INTERVAL` | `30s`
|============
...
|============
| Environment                     | Django/Flask      | Default
| `ZUQA_DISABLE_METRICS`   | `DISABLE_METRICS` | `None`
|============
...
|============
| Environment                       | Django/Flask        | Default
| `ZUQA_BREAKDOWN_METRICS`   | `BREAKDOWN_METRICS` | `True`
|============
...
|============
| Environment                       | Django/Flask        | Default
| `ZUQA_CENTRAL_CONFIG`      | `CENTRAL_CONFIG`    | `True`
|============
...
|============
| Environment                       | Django/Flask        | Default
| `ZUQA_GLOBAL_LABELS`       | `GLOBAL_LABELS`     | `None`
|============
...
|============
| Environment                              | Django/Flask                 | Default
| `ZUQA_DISABLE_LOG_RECORD_FACTORY` | `DISABLE_LOG_RECORD_FACTORY` | `False`
|============
...
|============
| Environment                                  | Django/Flask                     | Default
| `ZUQA_USE_ELASTIC_TRACEPARENT_HEADER` | `USE_ELASTIC_TRACEPARENT_HEADER` | `True`
|============
...
Additionally, when this setting is set to `True`, the agent will set `zuqa-traceparent` for backwards compatibility.
...
| `ZUQA_DJANGO_TRANSACTION_NAME_FROM_ROUTE`  | `DJANGO_TRANSACTION_NAME_FROM_ROUTE` | `False`
|============
...
|============
| Environment                                 | Django                         | Default
| `ZUQA_DJANGO_AUTOINSERT_MIDDLEWARE`  | `DJANGO_AUTOINSERT_MIDDLEWARE` | `True`
|============

To trace Django requests, the agent uses a middleware, `zuqa.contrib.django.middleware.TracingMiddleware`.
